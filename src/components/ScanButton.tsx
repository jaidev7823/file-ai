  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center gap-4">
        ...
        <Button onClick={handleDriveIndex} variant="destructive" disabled={loadingIndex || loadingScan}>
          {loadingIndex ? (progress ? `${progress.stage}...` : "Indexing Drive...") : "Index Whole Drive"}
        </Button>
      </div>
              ...
              <span className="text-sm font-medium capitalize">
                {(() => {
                  switch (progress.stage) {
                    ...
                    case "reading metadata": return "📖 Reading Metadata";
                    case "reading": return "📖 Reading Files";
                    case "embedding": return "🧠 Generating Embeddings";
                    case "storing": return "💾 Storing in Database";
                    case "phase2_discovery": return "🔍 Discovering Drives";
                    case "phase2_scanning": return "📱 Scanning System";
                    case "phase2_scan_complete": return "✅ Drive Scan Complete";
